...
def gendata(seed=2023, read_origin=False, if_RAF_aug=False, filepath_suff=''):
    ...
    pathTrain_idx = './data/DiffTrain_idx'+filepath_suff+'.npy'
    pathTest_idx = './data/DiffTest_idx'+filepath_suff+'.npy'
    pathVal_idx = './data/DiffVal_idx'+filepath_suff+'.npy'

    datafolder = 'pretrained'  # set the folder name
    path = './save/' + datafolder + '/generated_outputs_nsample' + filepath_suff + '.pk'
    if (not read_origin):
